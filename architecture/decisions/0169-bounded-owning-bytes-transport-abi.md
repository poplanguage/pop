...
The adapters copy between managed immutable storage and the operating-system
...
transport statuses, and UDP source facts. Borrowed-view sends and reusable
receive buffers may optimize copies later without changing these semantics.
