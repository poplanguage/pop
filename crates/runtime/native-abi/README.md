...
compatible ABI 2.1 descriptor for the same typed scalar-read adapter. ABI 2 owns the
...
production facade is the complete ABI 2.1 composition; the default facade
