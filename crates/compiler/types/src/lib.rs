...
pub use bootstrap::{
    ...
    NET_UDP_WAIT_TRANSFER_TYPE_ID, NET_UNIX_LISTENER_TYPE_ID, NET_UNIX_STREAM_TYPE_ID,
    NET_WAIT_TRANSFER_TYPE_ID, TEXT_VIEW_TYPE_ID, TIME_LIVE_DEADLINE_TYPE_ID,
    TIME_MONOTONIC_CLOCK_TYPE_ID, embedded_bootstrap_schema, ffi_c_integer_kind,
